...
struct task_t
{
    Anytask* ptrObject; // ponteiro do objeto onde encontra-se o metodo que vai ser escalonado
    void (Anytask::*task)(void); // ponteiro para uma função
...
public:
    ...
    int addTask(void (Anytask::*task)(void), Anytask* newObject, int time, int priority);
